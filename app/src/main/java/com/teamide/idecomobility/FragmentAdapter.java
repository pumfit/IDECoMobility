...
public class FragmentAdapter extends RecyclerView.Adapter<FragmentAdapter.ViewHolder> {
    ...
    public FragmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.recycler_subwayinfo_item, parent, false);
        FragmentAdapter.ViewHolder vh = new FragmentAdapter.ViewHolder(view);

        return vh;
    }

    @Override
    public void onBindViewHolder(@NonNull final FragmentAdapter.ViewHolder holder, final int position) {
